...
def real_data_loading (data_name, seq_len):
  ...
  """  
  assert data_name in ['wq_univariate','wq_multivariate']
  
  if data_name == 'wq_univariate':
    ori_data = np.loadtxt('data/wq_univariate_data.csv', delimiter = ",",skiprows = 1)
  elif data_name == 'wq_multivariate':
    ori_data = np.loadtxt('data/wq_multivariate_data.csv', delimiter = ",",skiprows = 1)
